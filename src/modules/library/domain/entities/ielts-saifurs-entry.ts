/**
 * One IELTS Saifur's-style card: the word, two accents, the Bangla meaning,
 * and the sentence that shows it in use.
 */
export class IeltsSaifursEntry {
  private constructor(
