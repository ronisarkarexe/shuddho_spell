...
export const NAV_ITEMS: readonly INavItem[] = Object.freeze([
  ...
  { href: '/library', labelKey: 'library', glyph: 'library' },
  {
    ...
    glyph: 'families',
    children: topicChildren('/library/families', 'familyTopic', FAMILY_NAV_TOPICS, 'families'),
  },
  {
  ...
  { href: '/library/saifurs', labelKey: 'saifurs', glyph: 'bookmark' },
  { href: '/library/ielts-saifurs', labelKey: 'ieltsSaifurs', glyph: 'globe' },
  { href: '/library/extra-vocab', labelKey: 'extraVocab', glyph: 'extra' },
  { href: '/library/adj-verb-adv', labelKey: 'adjVerbAdv', glyph: 'columns' },
  {
  ...
  { href: '/library/verbs', labelKey: 'verbs', glyph: 'verb' },
  { href: '/library/verb-roadmap', labelKey: 'verbRoadmap', glyph: 'roadmap' },
  { href: '/library/prepositions', labelKey: 'prepositions', glyph: 'around' },
  { href: '/library/questions', labelKey: 'questionWords', glyph: 'question' },
  { href: '/library/patterns', labelKey: 'gapFill', glyph: 'gap' },
